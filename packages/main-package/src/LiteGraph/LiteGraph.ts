...
export let LiteGraph = {
    ...
    Globals: {}, //used to store lets between graphs
    ...
    auto_load_slot_types: false, // [if want false, use true, run, get lets values to be statically set, than disable] nodes types and nodeclass association with node types need to be calculated, if dont want this, calculate once and set registered_slot_[in/out]_types and slot_types_[in/out]
