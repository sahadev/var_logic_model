...
export class LGraphNode {
    ...
    */
     ...
     */
    getSlotInPosition(x: number, y: number): object {
        //search for inputs
 ...
 * @return {boolean}
 */
function isPointInside(x: number, y: number, margin, skip_title): boolean {
    margin = margin || 0;
...
LGraphNode.prototype.isPointInside = isPointInside;
LGraphNode.prototype.setDirtyCanvas = setDirtyCanvas;
...
LGraphGroup.prototype.isPointInside = isPointInside;
LGraphGroup.prototype.setDirtyCanvas = setDirtyCanvas;
